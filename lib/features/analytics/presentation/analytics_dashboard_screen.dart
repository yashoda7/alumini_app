            ...
            builder: (context, snapshot) {
              ...
              return Column(
                children: [
                  ...metrics
                      .take(5)
                      .map((metric) => _EngagementCard(metric: metric)),
                ],
              );
            },
          ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(metric.userName, style: AppTextStyles.titleMedium),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text('${metric.postsCreated}', style: AppTextStyles.caption),
                ],
              ),
              const SizedBox(height: AppSpacing.xs),
              Row(
                children: [
                  ...
                  const SizedBox(width: AppSpacing.xs),
                  Text('${metric.commentsMade}', style: AppTextStyles.caption),
                ],
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return AppElevatedCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Engagement Metrics', style: AppTextStyles.titleMedium),
          const SizedBox(height: AppSpacing.md),
          _InsightRow(
