...
class MentorshipListScreen extends StatelessWidget {
...
class _MentorshipSlotCard extends StatelessWidget {
  const _MentorshipSlotCard({
    required this.slot,
    required this.currentUser,
    required this.firestoreService,
  });
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'Introduce yourself and explain why you want mentorship...',
              ),
            ),
          ],
        ),
